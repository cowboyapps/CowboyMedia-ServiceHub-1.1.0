...
export function EmptyState({
  ...
  return (
    <div className="px-5 py-10 flex flex-col items-center justify-center text-center animate-fade-in">
      <span className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 dark:bg-primary/20 ring-1 ring-primary/10 dark:ring-primary/20 mb-3 animate-scale-in">
